...
wchar_t getopt(int argc, wchar_t *argv[], wchar_t *optstring)
{
	...
	wchar_t foundOptionChar = *next++;
	wchar_t *cp = wcschr(optstring, foundOptionChar);

	if (cp == NULL || foundOptionChar == L':')
		return L'?';
